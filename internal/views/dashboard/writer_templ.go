...
func Writer() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<h2>This is the Writer Form</h2><form enctype=\"multipart/form-data\" action=\"/dashboard/writer/new\" method=\"post\"><input type=\"text\" id=\"article-title\" name=\"article-title\"> <input type=\"file\" id=\"article-file\" name=\"article-file\" accept=\".md\"> <button type=\"submit\">Upload</button></form>")
